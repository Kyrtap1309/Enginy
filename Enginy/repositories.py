...
class EnginePartRepository:
    ...
    @staticmethod
    def get_part_with_dependencies(part_id: str) -> Tuple[Dict[str, Any], List[Dict[str, Any]]]:
        """
    ...
    def get_part_object(part_id: str) -> Union[BaseEnginePart, None]:
        ...
        """
        part, direct_dependencies = EnginePartRepository.get_part_with_dependencies(part_id)
        if not part:
            return None
    ...
    def save_analysis_result(part_id: str, analysis_data: str) -> bool:
        ...
        try:
            ...
            db.engine_parts.update_one(
                ...
                {'$set': {'analysis_result': analysis_data, 'analyzed_at': datetime.now()}}
            )
            return True
        except Exception:
            return False
